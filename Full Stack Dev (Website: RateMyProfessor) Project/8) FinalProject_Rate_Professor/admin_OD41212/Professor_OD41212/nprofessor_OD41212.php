...
echo "<Center>";
echo "<H1> Insert New Professor Data        ---     <A Href=/~andylo1/FinalProject_Rate_Professor/admin_OD41212/page1_OD41212.php> Home </A></H1>";
echo "<Form action=insertprofessor_OD41212.php method=post>";
echo "<Table border=0>";
echo "<Tr><Td>";
